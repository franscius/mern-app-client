...
function Booking() {
  ...
  const [bids, setBids] = useState({
    ...
    bid: undefined,
    sdate: format(dates[0].startDate, "yyyy-MM-dd"),
    edate: format(dates[0].endDate, "yyyy-MM-dd"),
    un: user.username,
    ue: user.email,
    rn: undefined,
    hn: undefined,
      ...
      <div className="contentArea">
        ...
        <div className="right">
          ...
          <div >
            ...
            <form >
              <span className="itemKey">Booking Id:</span>
              <input className="tp1" onChange={handleChange} id="bid" value={selectedRooms} type="text" required="true" />
              <span className="itemKey">From Date :</span>
              <input className="tp1" onChange={handleChange} id="sdate" value={format(dates[0].endDate, "yyyy-MM-dd")} type="date" required="true" />

              <span className="itemKey">To Date :</span>
              <input className="tp1" onChange={handleChange} id="edate" value={format(dates[0].endDate, "yyyy-MM-dd")} type="date" required="true" />

              <span className="itemKey">User Name :</span>
              <input className="tp1" onChange={handleChange} id="un" value={user.username} type="text" required="true" />

              <span className="itemKey">Email :</span>
              <input className="tp1" onChange={handleChange} id="ue" value={user.email} type="text" required="true" />
